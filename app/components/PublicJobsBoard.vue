...
/**
 * Public open-roles board — search, type filter, and pagination over
 * `/api/public/jobs`. Extracted from the /jobs page so it can also serve as the
 * site home page (app/pages/index.vue). Page-level concerns (layout, SEO meta)
 * live in the pages that render this component.
 */
