...
import { ArrowRight, Cloud, Sparkles } from 'lucide-vue-next'
        ...
        <div class="relative p-4">
          ...
          <div class="mt-3.5">
            ...
            >
              ...
              <span class="text-[12px] font-semibold text-white/70 transition-colors group-hover:text-white">Create free workspace</span>
          ...
          <p class="mt-2.5 truncate text-center text-[10px] text-white/25">
            300 applicants included · No credit card required
          </p>
        </div>
      </div>
    </div>
