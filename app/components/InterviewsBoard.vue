...
/**
 * The interviews board: filters, list/calendar views, and bulk reviewer
 * assignment. Renders the org-wide board by default; pass `jobId` to scope it
 * to a single job (used by the job's Interviews tab).
 */
