...
useSeoMeta({
  title: 'Join Organization — Pegasus Media Project',
  description: 'Accept an invitation to join an organization on Pegasus Media Project',
...
<template>
  ...
  <div v-else-if="linkInfo" class="flex flex-col gap-5">
    <div class="text-center">
      ...
      <p class="text-sm text-surface-500 dark:text-surface-400">You've been invited to join a team on Pegasus Media Project.</p>
    </div>
