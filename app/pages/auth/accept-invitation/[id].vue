...
useSeoMeta({
  title: 'Accept Invitation — Pegasus Media Project',
  description: 'Accept an organization invitation on Pegasus Media Project',
...
<template>
  ...
  <div v-else class="flex flex-col gap-5">
    <div class="text-center">
      ...
      <p class="text-sm text-surface-500 dark:text-surface-400">
        You've been invited to join an organization on Pegasus Media Project.
      </p>
    </div>
